		...
		if (one_of_minute_anim == 0) {
			...
			if (ten_of_minute_anim == 0) {
				...
				if (one_of_hour_anim == 0) {
					...
					if (ten_of_hour_anim == 0) {
						if (flag == 1) {
							// Slide from the left on ten of hour column
							GRect start = GRect(-40 , 148, 144, 168);
							GRect finish = GRect(-80, 148, 144, 168);
						...
						if (flag == 1) {
							// Slide from the left on ten of hour column
							GRect start = GRect(-40 , 148 - ((ten_of_hour_anim - 1)*18), 144, 168);
					...
					if (flag == 1) {
						...
						GRect finish = GRect(36, 148 - ((one_of_hour_anim - 1)*18), 144, 168);
